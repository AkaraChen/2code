...
use sandbox_agent_agent_management::agents::{
    AgentError, AgentId, AgentInstallStatus, AgentManager, AgentProcessLaunchSpec, InstallOptions,
    InstallResult,
};
use serde::Serialize;
...
impl AgentManagerWrapper {
    ...
    pub fn install(&self, agent_str: &str) -> Result<InstallResult, AgentError> {
    ...
    pub fn resolve_launch(&self, agent_str: &str) -> Result<AgentProcessLaunchSpec, AgentError> {
        let agent = parse_agent_id(agent_str)?;
