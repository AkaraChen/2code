...
pub fn run() {
	...
	let app = tauri::Builder::default()
		...
		.invoke_handler(tauri::generate_handler![
			...
			handler::project::list_git_remotes,
			handler::project::list_git_remote_branches,
			handler::project::list_git_tags,
			handler::project::checkout_git_branch,
			handler::project::create_git_branch,
			handler::project::delete_git_branch,
			handler::project::rename_git_branch,
			handler::project::git_fetch,
			handler::project::git_pull,
			handler::project::git_push_with_lease,
			handler::project::git_merge_ref,
			handler::project::git_rebase_onto,
			handler::project::git_delete_remote_branch,
			handler::project::git_rename_remote_branch,
			handler::project::list_git_stashes,
			handler::project::git_stash_push,
			handler::project::git_stash_pop,
			handler::project::git_stash_apply,
			handler::project::git_stash_drop,
			handler::project::get_in_progress_op,
			handler::project::continue_in_progress_op,
			handler::project::abort_in_progress_op,
			handler::project::get_conflict_state,
			handler::project::mark_conflict_resolved,
			...
			handler::project::amend_head_commit_message,
			handler::project::rewrite_git_commits,
			handler::project::rewrite_force_push_required,
