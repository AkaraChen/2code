 ...
 * Generated at: 2026-03-08T13:45:56.059016+00:00
 * Generator: none
 *
...
export type AgentEvent =
	| { type: "Notification"; method: string; params: string }
	| { type: "TurnComplete"; session_id: string; stop_reason: string }
...
export interface InstallSkillFromRegistryParams {
	source: string;
	skill: string;
	[key: string]: unknown;
}
...
export interface GetAgentSessionModesParams {
	sessionId: string;
	[key: string]: unknown;
}

export interface SetAgentSessionModeParams {
	sessionId: string;
	modeId: string;
	[key: string]: unknown;
}
