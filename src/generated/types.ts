 ...
 * Generated at: 2026-05-05T17:20:30.891781+00:00
 * Generator: none
 *
...
export interface QuickTaskPtyEvent {
  runId: string;
  event: string;
  data?: string | null;
}
...
export interface StartQuickTaskPtyParams {
  runId: string;
  shell?: string | null;
  cwd: string;
  command: string;
  rows: number;
  cols: number;
  onEvent: Channel<QuickTaskPtyEvent>;
  [key: string]: unknown;
}


export interface WriteQuickTaskPtyParams {
  runId: string;
  data: string;
  [key: string]: unknown;
}
...
export interface ResizeQuickTaskPtyParams {
  runId: string;
  rows: number;
  cols: number;
  [key: string]: unknown;
...
export interface StopQuickTaskPtyParams {
  runId: string;
  [key: string]: unknown;
}
