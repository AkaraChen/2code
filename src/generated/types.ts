 ...
 * Generated at: 2026-07-03T13:47:58.594142+00:00
 * Generator: none
 *
...
export interface FrontendProfileEvent {
  name: string;
  entry_type: string;
  time_origin: number;
  start_time: number;
...
export interface FilePreview {
  ...
  archive_entries?: ArchivePreviewEntry[] | null;
}
...
export interface GetGitDiffSnapshotParams {
  profileId: string;
  [key: string]: unknown;
}
...
export interface ListGitBranchesParams {
  profileId: string;
  [key: string]: unknown;
}


export interface CheckoutGitBranchParams {
  profileId: string;
  branch: string;
  [key: string]: unknown;
}
...
export interface AttachPtyOutputParams {
  sessionId: string;
  streamId: string;
  [key: string]: unknown;
}
...
export interface StreamPtyOutputParams {
  sessionId: string;
  streamId: string;
...
export interface DetachPtyOutputParams {
  sessionId: string;
  streamId: string;
  [key: string]: unknown;
}
...
export interface CreateFileTreePathParams {
  profileId: string;
  path: string;
  kind: string;
  [key: string]: unknown;
...
export interface RevealPathInFileManagerParams {
  profileId: string;
  path?: string | null;
  [key: string]: unknown;
}
...
export interface OpenPathInDefaultAppParams {
  profileId: string;
  path: string;
  [key: string]: unknown;
}
...
export interface CreateProfileParams {
  projectId: string;
  branchName: string;
  defaultWorktreeDir?: string | null;
  [key: string]: unknown;
}
...
export interface AppendFrontendProfileEventsParams {
  events: FrontendProfileEvent[];
  [key: string]: unknown;
}



export interface SetPerformanceProfileEnabledParams {
  enabled: boolean;
  [key: string]: unknown;
}
