 ...
 * Generated at: 2026-05-05T17:20:30.892308+00:00
 * Generator: none
 *
...
export async function startQuickTaskPty(params: types.StartQuickTaskPtyParams): Promise<void> {
  return invoke('start_quick_task_pty', params);
}


export async function writeQuickTaskPty(params: types.WriteQuickTaskPtyParams): Promise<void> {
  return invoke('write_quick_task_pty', params);
}


export async function resizeQuickTaskPty(params: types.ResizeQuickTaskPtyParams): Promise<void> {
  return invoke('resize_quick_task_pty', params);
}


export async function stopQuickTaskPty(params: types.StopQuickTaskPtyParams): Promise<void> {
  return invoke('stop_quick_task_pty', params);
}
