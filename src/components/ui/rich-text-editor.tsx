...
export const RichTextEditorRoot = function RichTextEditorRoot({
	ref,
	...props
}: RichTextEditorProps & { ref?: React.RefObject<HTMLDivElement | null> }) {
...
export const RichTextEditorToolbar = function RichTextEditorToolbar({
	ref,
	...props
...
export const RichTextEditorFooter = function RichTextEditorFooter({
	ref,
	...props
...
export const RichTextEditorContent = function RichTextEditorContent({
	ref,
	...props
...
export const RichTextEditorControlGroup = function RichTextEditorButtonGroup({
	ref,
	...props
